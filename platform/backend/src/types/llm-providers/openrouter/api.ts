 ...
 *
 * OpenRouter exposes an OpenAI-compatible API server, so we re-export OpenAI schemas.
  ...
  .object({
    ...
    message: z
      .object({
        ...
        // OpenRouter-specific: reasoning field for models that support it
...
export const ChatCompletionRequestSchema = z
  ...
  .describe("OpenRouter chat completion request");
...
export const ChatCompletionResponseSchema = z
  ...
  .describe("OpenRouter chat completion response");
...
export const ChatCompletionsHeadersSchema = z.object({
  ...
  authorization: z
    .string()
    .optional()
    .describe("Bearer token for OpenRouter API authentication")
