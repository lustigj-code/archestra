/**
 * x.ai Interaction Utils
 *
 * x.ai exposes an OpenAI-compatible API, so we can reuse the OpenAI interaction class.
 ...
 * This class handles x.ai chat completion interactions identically to OpenAI.
 */
class XaiChatCompletionInteraction implements InteractionUtils {
  // x.ai uses OpenAI-compatible types
