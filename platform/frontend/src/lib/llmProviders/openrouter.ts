 ...
 *
 * OpenRouter exposes an OpenAI-compatible API, so we can reuse the OpenAI interaction class.
 ...
 * This class handles OpenRouter chat completion interactions identically to OpenAI.
 */
class OpenrouterChatCompletionInteraction implements InteractionUtils {
  // OpenRouter uses OpenAI-compatible types
